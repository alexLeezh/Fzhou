...
<?php endif; ?>
<style>
.input-tip-message{border:5px dashed red;}
</style>
</head>
<body>
...
.input-tip-p{display:none;margin-left:20px; color:#a1a0a0;}
...
echo parse_url_tag("u:project#saveEasy|"."".""); 
?>" method="post">									
					<div class="form_row my_form_row">
						<label class="title w100 my_title cc-tip-control" ref="tip1" style="height:40px;line-height:50px;width:150px;float:none;">项目的简介与定位</label>
                        <a id="btn_jianjie" href="#" class="tip_control"></a>
                        <div><p class="input-tip-p" id="tip1">请用一句话描述你想做的事情。这句话将作为您的项目简介出现在展示单元中，同时还会出现在项目内页最显眼的位置。作为一个直观展示的基本信息，请务必在简练明确的基础上发挥您最高的文字功底吸引支持者。试想如果您把您的项目写成一条微博，怎么才能让您的粉丝快速的了解这个项目到底想做什么？<div class="blank15"></div></p></div>
                        
						<div class="clearfix"></div>
						<div class="form_row">
							<textarea id="brief" name="brief" class="textarea3 input-tip-control" ref="tip1"><?php echo $this->_var['deal']['brief']; ?></textarea>
		        ...
		        <div class="deal-info clear">
		          <div class="deal-info-left">
		            <div class="deal-remark box">
		              ...
		              <div class="blank"></div>
		              <div class="content deal-input-box"> <span id="deal_brief"><?php if ($this->_var['deal']['brief'] == ''): ?>项目的简介与定位<?php else: ?><?php echo $this->_var['deal']['brief']; ?><?php endif; ?></span> </div>
		            </div>
		            <div class="blank"></div>
		        ...
		        <div class="deal-other">
		          ...
		          <div class="deal-bottom">
		            <div id="project_detial" class="deal-show-item clear" style="display:block;">
		              <div class="deal-detial-other" style="width:737px;">
