...
{//类定义开始
    ...
    public function _imgUpload($attr)
    {
        ...
        $parseStr="<div style='width:120px; height:40px; margin-left:10px; display:inline-block;  float:left;' class='none_border'><script type='text/javascript'>var eid = '".$id."';".
		            	...
		            	$parseStr.= "<img src='".$img_url."' ".$script." style='display:inline-block; float:left; cursor:pointer; margin-left:10px; border:#f2f2f0 solid 1px; width:".$width."px; height:".$height."px;' id='img_".$id."' />";
		            	$parseStr.= "<img src='".__ROOT__."/admin/Tpl/default/Common/images/del.gif' style='".$hide." margin-left:10px; float:left; border:#f2f2f0 solid 1px; width:35px; height:35px; cursor:pointer;' id='img_del_".$id."' onclick='delimg(\"".$id."\")' title='删除' />";
        return $parseStr;
    }
}//类定义结束
?>