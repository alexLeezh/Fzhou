...
if($module!="ajax")
{
	...
	$GLOBALS['tmpl']->assign("site_foot_my",app_conf("SITE_FOOT_MY"));
	$GLOBALS['tmpl']->assign("site_foot_question",app_conf("SITE_FOOT_QUESTION"));
	$GLOBALS['tmpl']->assign("site_foot_project",app_conf("SITE_FOOT_PROJECT"));
	$GLOBALS['tmpl']->assign("site_foot_way",app_conf("SITE_FOOT_WAY"));
	$GLOBALS['tmpl']->assign("site_foot_desc",app_conf("SITE_FOOT_DESC"));
